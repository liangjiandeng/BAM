...
if __name__ == "__main__":
    ...
    train_set = DatasetFromHdf5('/Data/Machine Learning/Jin-Fan Hu/3-multistage/train_harvard(with_up)x4.h5')  # creat data for training
    training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches

    validate_set = DatasetFromHdf5('/Data/Machine Learning/Jin-Fan Hu/3-multistage/validation_harvard(with_up)x4.h5')  # creat data for validation
