...
def save_checkpoint(model, epoch):  # save model function
    model_out_path = 'Weight/NET'+'_{}.pth'.format(epoch)
...
if __name__ == "__main__":
    ...
    train_set = DatasetFromHdf5('/Data/DataSet/HISR/Harvard/train_harvard.h5')  # creat data for training
    training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches

    validate_set = DatasetFromHdf5('/Data/DataSet/HISR/Harvard/validation_harvard.h5')  # creat data for validation
